...
import (
	...
	"github.com/go-openapi/strfmt" // Added for strfmt.Registry
	rclient "github.com/sigstore/rekor/pkg/client"
	"github.com/sigstore/rekor/pkg/generated/client"
	"github.com/sigstore/rekor/pkg/generated/client/log" // Subpackage of github.com/sigstore/rekor
	"github.com/sigstore/rekor/pkg/generated/models"     // Subpackage of github.com/sigstore/rekor
)

// RekorTreeState represents the state of the Rekor transparency log
...
// StoredRekorState holds the last known state
...
func getCurrentTreeState(rekorClient *client.Rekor) (*RekorTreeState, error) {
	// Use log client to get tree state
	params := log.NewGetLogInfoParams()
	resp, err := rekorClient.Log.GetLogInfo(params, runtime.ClientAuthInfoWriterFunc(func(r runtime.ClientRequest, _ strfmt.Registry) error {
		return nil
	}))
	if err != nil {
		return nil, err
